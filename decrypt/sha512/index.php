...
if (isset($hash) and isset($type)){
	$get = get($url."/api/decrypt.php?type=sha512&hash=".$hash);
...
<input type='text/ placeholder='Failed to crack' class='is-invalid form-control' id='hasil' value='Failed to crack' readonly";
		...
		$result = "<input type='text/ placeholder='Please input sha512' class='is-invalid form-control' id='hasil' value='Failed to crack' readonly";
	}
}
?>
<html>
