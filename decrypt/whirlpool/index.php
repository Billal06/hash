...
$url = "http://localhost:8080/rhashid";
$type = $_POST["type"];
$hash = $_POST["hash"];
if (isset($hash) and isset($type)){
	$get = get($url."/api/decrypt.php?type=whirlpool&hash=".$hash);
...
<input type='text' placeholder='$text' class='is-valid form-control' id='hasil' value='$text' readonly>";
			...
			$result = "
<input type='text/ placeholder='Failed to crack' class='is-invalid form-control' id='hasil' value='Failed to crack' readonly";
		}
	}else{
		$result = "
<input type='text/ placeholder='Please input md5' class='is-invalid form-control' id='hasil' value='Failed to crack' readonly";
	}
}
?>
<html>
				...
				<ul class="navbar-nav mr-auto">
					...
					<div class="nav-item dropdown">
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							...
							<a href="../../encrypt/whirlpool" class="dropdown-item">WHIRLPOOL</a>                                                                                                                                                 </div>                                                                                            </div>
				</ul>
			</div>
		</nav>
			...
			<div class="card bg-dark">
				...
				<div class="card-body">
					<form action="" method="POST">
						...
						<input type="text" id="hash" name="hash" class="form-control" placeholder="XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX" value="<?php echo $hash; ?>" required>
							<small class="text-muted text-white">Must be 128 characters long</small>
						</div>
						<div class="mb-4 p-3 text-center">
							<button class="btn btn-primary">Crack</button>
						</div>
					</form>
					<div id="result">
						<?php
