...
if (isset($hash) and isset($type)){
	$get = get($url."/api/decrypt.php?type=sha1&hash=".$hash);
...
<input type='text/ placeholder='Failed to crack' class='is-invalid form-control' id='hasil' value='Failed to crack' readonly";
		...
		$result = "<input type='text/ placeholder='Please input sha1' class='is-invalid form-control' id='hasil' value='Failed to crack' readonly";
	}
}
?>
<html>
				...
				<div class="card-body">
					<form action="" method="POST">
						...
						<input type="text" id="hash" name="hash" class="form-control" placeholder="XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX" value="<?php echo $hash; ?>" required>
							<small class="text-muted text-white">Must be 64 characters long</small>
						</div>
